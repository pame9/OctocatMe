# project noname (0.0.1) configured on Sun Feb 26 10:07:43 2012 by
...
ok /usr/local/Cellar/node/0.4.8
...
[0m['/usr/bin/g++', '-g', '-I/usr/sfw/lib', '-I/opt/local/includes', '-I/usr/local/includes', '-I/usr/includes', '-I/usr/include', '../test.cpp', '-c', '-o', 'default/test_1.o']
...
['/usr/bin/g++', 'default/test_1.o', '-o', '/Users/jpb/dev/octocatme/OctocatMe/backend/node_modules/bcrypt/build/.conf_check_0/testbuild/default/testprog', '-L/lib', '-L/usr/lib', '-L/usr/local/lib', '-L/opt/local/lib', '-L/usr/sfw/lib', '-lssl']
